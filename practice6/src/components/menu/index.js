...
export default function Menu() {
  ...
  return (
    <div
      className={`w-96 blue text-slate-100 h-auto ${menus} fixed h-full  max-[800px]:w-full z-20`}
    >
      <div>
        ...
        <div className="pt-4">
          ...
          <div className="flex flex-row py-4 cursor-pointer">
            ...
            <Link href="/class" className="basis-5/6">
              Class quotes
            </Link>
          </div>
          <div className="flex flex-row py-4 cursor-pointer">
            ...
            <Link href="/all" className="basis-5/6">
              All quotes
            </Link>
          </div>
        </div>
